...
describe "Test Queue Implementation" do
  ...
  it "adds something to an empty Queue" do
    ...
    q.to_s.must_equal "[10, nil, nil, nil, nil, nil, nil, nil, nil, nil]"
  end
  ...
  it "adds multiple somethings to a Queue" do
    ...
    q.to_s.must_equal "[10, 20, 30, nil, nil, nil, nil, nil, nil, nil]"
  end
  ...
  it "works for a large Queue" do
    ...
    expect(q.to_s).must_equal("[200, 210, nil, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 150, 160, 170, 180, 190]")
  end
end
